...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/chart.js?<?php echo time(); ?>"></script>
...
<div class="topbar">
    ...
    <!-- cart icon end -->
      ...
      <img src="file:///C:/Users/Aremu_damilare/JS_projects/lasfunding/final_frontend/user/user/images/icons/hamburger.svg" alt="" srcset="file:///C:/Users/Aremu_damilare/JS_projects/lasfunding/final_frontend/user/user/dashboard.html "></button> 
    -->
	  </div>
  ...
  <script src="../backend/admin/dashboard.js?<?php echo time(); ?>"></script>
