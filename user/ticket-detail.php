            ...
            <div class="right-navbar-wrapper">
              ...
              <div class="right-navbar-link">
               ...
               <div class="right-navbar-link">
                ...
                <a href="./tickets.php" class="rl_navbar1_link w-nav-link" style="color: #e04800;">Tickets <img src="../images/icons/CaretRight.svg" alt="" srcset=""></a>
              </div>
            ...
            <div class="card comp-card">
               <div class="card-body">
                  <div class="row align-items-center">
                     <div class="col">ID: <span id="ticketId"></span>
                        <div>priority: subject</div>
                        <h6 class="m-b-25"><span id="ticketPriority"></span>: <span id="ticketSubject"></span></h6>
                        <div>dept: status</div>
                        <h6 class=""><span id="ticketDept"></span>: <span id="ticketStatus"></span></h6>
                        <div>Date</div>
                        <p class="m-b-0"><span id="ticketDate"></span> </p>
                     </div>
                     <div class="col-auto">
        ...
        try {
            ...
            if (ticketDetail) {
                ...
                for (const ticketComment of ticketComments) {
                    ...
                    listItem.textContent = ticketComment.content;
