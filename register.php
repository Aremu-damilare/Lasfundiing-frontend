...
<head>
  ...
  <style>
    ...
    *{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;}
    ...
    .submit-button-2{width:100%;margin:32px auto 19px;border-radius:14px;background-color:rgba(224, 72, 0, 0.88);font-size:18px;text-align:center;}
      ...
      <div class="column-3 w-col w-col-6">
        <div class="order-summary">
          ...
          <div class="billing-form w-form">
              ...
              <button type="submit" id="submitBtn" value="Sign Up" data-wait="Please wait..." class="submit-button-2 w-button"> 
                Sign up
