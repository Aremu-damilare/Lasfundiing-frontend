...
<html data-wf-page="6450fd66000ac1aa2a46cfa4" data-wf-site="63807ab0318db8bd26b06087">
<head>
  <meta charset="utf-8">
      ...
      <div class="navbar-wrapper">
        ...
        <nav role="navigation" class="nav-menu-wrapper w-nav-menu">
          <ul role="list" class="nav-menu w-list-unstyled">
            <li>
              <a href="#" class="nav-link-2 how-it-works">How it works</a>
            </li>
            <li>
              <a href="#" class="nav-link-2">Programs</a>
            </li>
            <li>
              <a href="#" class="nav-link-2">FAQ</a>
            </li>
            <li>
              <a href="contact.html" aria-current="page" class="nav-link-2 w--current">Contact</a>
            </li>
            <li class="mobile-margin-top-10">
              <div class="nav-button-wrapper">
                <a data-w-id="39763524-28b0-34c5-f0e4-c2a338dcd4f5" href="#" class="nav-link-2 sign-in login">Sign In</a>
                <a href="register.html" class="button-primary nav-bar w-button">Join Now</a>
  ...
  <div class="contact-section wf-section">
    <div class="contact-container w-container">
      <div class="contact-header">
        ...
        <div class="contact-whatsapp-button-wrapper"><img src="images/WhatsappLogo.svg" loading="lazy" alt="" class="image-19">
          <a href="#" class="whatsapp-button w-button">Whatsapp</a>
        </div>
      </div>
      <div class="contact-text">You can send your emails and contact us here.</div>
      <div class="w-form">
        <form id="email-form" name="email-form" data-name="Email Form" method="get" class="contact-form"><label for="name" class="contact-field">Name required*</label><input type="text" class="text-field-2 w-input" maxlength="256" name="name" data-name="Name" placeholder="Enter your name" id="name" required=""><label for="email" class="contact-field">Email required*</label><input type="email" class="text-field-3 w-input" maxlength="256" name="email" data-name="Email" placeholder="Enter email" id="email" required=""><label for="Message" class="contact-field">What problems are you facing?</label><input type="text" class="text-field-4 w-input" maxlength="256" name="Message" data-name="Message" placeholder="" id="Message" required=""><input type="submit" value="Send" data-wait="Please wait..." class="contact-send-button w-button"></form>
          ...
          <div class="w-layout-grid rl_footer1_top-wrapper">
            ...
            <div class="w-layout-grid rl_footer1_menu-wrapper">
              ...
              <div class="rl_footer1_link-list">
                ...
                <div class="rl_footer1_spacing-block-4"></div>
                <a data-w-id="a8454ba9-aaca-eaca-df8f-a1abb34ceced" href="register.html" class="button-2 w-button">Trade Now</a>
              </div>
            </div>
          </div>
