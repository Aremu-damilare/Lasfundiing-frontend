...
<head>
  ...
  *{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;}
  ...
  .w-form-done{
    display:none;padding:20px;text-align:center;background-color:green;color:white;
  }
  .w-form-fail{
    display:none;margin-top:10px;padding:10px;background-color:red;color: white;
  }
