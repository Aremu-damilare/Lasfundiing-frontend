...
<html data-wf-page="6452dafcf3522763f13b70c2" data-wf-site="63807ab0318db8bd26b06087">
<head>
  <meta charset="utf-8">
  <title>Payment successful modal</title>
  <meta content="Payment successful modal" property="og:title">
  <meta content="Payment successful modal" property="twitter:title">
...
<body class="modal-body">
  <div class="modal-popup w-container">
    <div class="text-block-100">Payment successfully</div><img src="../images/Group-1171275068.svg" loading="lazy" width="63" alt="" class="image-20">
    <a href="#" class="button-7 w-button">Proceed to Dashboard</a>
  </div>
